 ...
 */
public class AdapterPaginaAbility extends ArrayAdapter<String> {
    ...
    public AdapterPaginaAbility(Context context, int resource, List<String> objects) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        TextView textView = (TextView) rowView.findViewById(R.id.textView_layout_elemento_lista_ability_nome);
